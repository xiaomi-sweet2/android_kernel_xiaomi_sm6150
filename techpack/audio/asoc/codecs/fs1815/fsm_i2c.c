...
static ssize_t fs1815_sysfs_set_enable(struct device *dev,
...
static DEVICE_ATTR(fs1815_enable, S_IWUSR | S_IRUGO,
	   NULL, fs1815_sysfs_set_enable);


static struct attribute *fs1815_pa_attr[] = {
	&dev_attr_fs1815_enable.attr,
	NULL,
};

 static const struct attribute_group fs1815_attr_group = {
	.attrs = fs1815_pa_attr,
};
			...
			const struct i2c_device_id *id)
{
	...
	if(fsm_dev->id == 0) {
 	...
 	ret = sysfs_create_group(&i2c->dev.kobj, &fs1815_attr_group);
